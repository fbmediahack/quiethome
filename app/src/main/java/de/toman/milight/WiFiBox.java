...
public class WiFiBox {
	...
	public static final int COMMAND_BRIGHTNESS_UP = 0x3C;

	public static final int COMMAND_BRIGHTNESS_DOWN = 0x34;

	/**
	 * The maximum brightness value, starting at 0.
	 */
	public static final int MAX_BRIGHTNESS = 0x1C;
	...
	public void brightnessUp() throws IOException,
			IllegalArgumentException {
		// send message to the WiFi box
		sendMessage(COMMAND_BRIGHTNESS_UP);
	}

	public void brightnessDown() throws IOException,
			IllegalArgumentException {
		// send message to the WiFi box
		sendMessage(COMMAND_BRIGHTNESS_DOWN);
	}
